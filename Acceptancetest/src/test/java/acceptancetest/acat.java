...
public class acat {
	...
	public String URL = "http://"+System.getenv().get("PROD_IP_AND_PORT")+"/ProdWebapp";
	public String URL1 = "http://"+System.getenv().get("PROD_IP_AND_PORT")+"/ProdWebapp/avncreatepage.jsp";
